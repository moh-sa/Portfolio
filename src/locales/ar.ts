...
const AR = {
  ...
  profile: {
    bio: {
      name: "محمد صبحي",
      description:
        "مهندس برمجيات مع بكالوريس في هندسة الكمبيوتر، شغوف بتطوير تطبيقات ويب متكاملة تجمع بين الشكل الجذاب، سهولة الاستخدام، والقدرات الاستثنائية لتقديم تجارب رقمية فريدة",
    },
    skills: {
      heading: "المهارات",
